                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="party_type" class="form-control border-bottom" id="validationCustom01"
                                            ...
                                            <option value="client" @if (old('party_type') == 'client') selected @endif>Client
                                            </option>
                                            <option value="vendor" @if (old('party_type') == 'vendor') selected @endif>Vendor
                                            </option>
                                            <option value="employee" @if (old('party_type') == 'employee') selected @endif>
                                                Employee</option>
                                        </select>
